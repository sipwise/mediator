...
static int cdr_parse_srcleg_json(char *srcleg, cdr_entry_t *cdr)
{
...
static int cdr_parse_dstleg_json(char *dstleg, cdr_entry_t *cdr)
{
...
static int cdr_parse_srcleg(char *srcleg, cdr_entry_t *cdr)
{
    ...
    if (!json || !json_object_is_type(json, json_type_object)) {
        ...
        json_object_put(json);
        return cdr_parse_srcleg_json(srcleg, cdr);
    }
...
static int cdr_parse_dstleg(char *dstleg, cdr_entry_t *cdr)
{
    ...
    if (!json || !json_object_is_type(json, json_type_object)) {
        ...
        json_object_put(json);
        return cdr_parse_dstleg_json(dstleg, cdr);
    }
